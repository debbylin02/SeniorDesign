...
//   const canvasSize = vec2.fromValues(window.innerWidth - 80, window.innerHeight - 270);
...
//     // fireball 
//     // renderer.render(camera, flat, topColor, bottomColor, tickCount, updatedFlameSize, [
//     //   icosphere,
//     // ]);
